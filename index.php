...
<?php function IndexHtmlPage()
{
    ...
    <head>
        ...
        <!-- - - - - - - - - - - - - GayQuery - - - - - - - - - - - - -->
        <script>
            const $g = x=>document.querySelectorAll(x);

            NodeList.prototype.mfw = (eventType, handler) => {
                console.log(this);
                Array.from(this).forEach(x => x.addEventListener(eventType, handler));
            }
        </script>
    ...
    <body>
        ...
        <based-page data-url="/" data-title="Home | Degeneracy">
            ...
            <div id="main_title">
                ...
                <span class="gq-test">1</span>
                <span class="gq-test">2</span>
                <span class="gq-test">3</span>
                <span class="gq-test">4</span>
                <span class="gq-test">5</span>
                <span class="gq-test">6</span>

                <script>
                    const a = $g("span.gq-test");
                    a.mfw("click", alert);
                </script>
            </div>
            <footer>
